...
class KLogger
{
		...
		public function __construct( $filepath , $priority , $fileSize = 500)
		{
			...
			if ( file_exists( $this->log_file ) )
			{
				...
				if ( filesize( $this->log_file ) >= 1024 * 1024 * $fileSize)
				{
					system('mv '.$this->log_file.' '.$this->log_file.'.'.date('YmdHms', time()));
				}
			}
